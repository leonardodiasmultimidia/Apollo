 ...
 */
public class IUCadastroDisco extends javax.swing.JFrame{

    /**
     * Creates new form IUCadastroDisco
     */
    Disco d;
    public IUCadastroDisco(Disco disco) {
        initComponents();
        d = disco;
        jTextFieldDuracao.setEditable(false);
        jTextFieldValor.setEditable(false);
        jTextFieldValor.setText("U$ "+disco.getValor());
        jTextFieldDuracao.setText(Utilitarios.formataDuracao(disco.getDuracao()));
        setVisible(true);
